function analizando() {
    ...
    if (dgvTabla.rows.length > 0) {
        dgvTabla.rows.clear();
    }

    // Pasando la expresión ingresada al textBox a una variable de tipo cadena
    let linea = document.getElementById("txtExpresion").value;
    ...
    let reservadas = [
        "T_si", "T_sino", "T_sinosi", "T_para", "T_mientras", "T_hacer", "t_si", "t_sino", "t_sinosi", "t_para", "t_mientras", "t_hacer"
    ];
    ...
    // Aquí puedes colocar el código que deseas ejecutar en cada iteración
        ...
        if (linea[i] === ';') {
            ...
            dgvTabla.Rows.Add(";", "t_fin", "Es un punto y coma.");
        ...
        // Analiza si el carácter es '¿'
            ...
            // Se agrega la fila
            dgvTabla.Rows.Add("¿", "t_interInicio", "Es el símbolo de interrogación inicial.");
            // Se muestra con el color que lo representa como símbolo
            dgvTabla.rows[fila].style.backgroundColor = "#ffcc66"; // Aquí puedes ajustar el color según tus necesidades
            fila++;
        }
        ...
        // Analiza si el carácter es '?'
            ...
            // Se agrega la fila
            dgvTabla.Rows.Add("?", "t_interFinal", "Es el símbolo de interrogación final.");
            // Se muestra con el color que lo representa como símbolo
            dgvTabla.rows[fila].style.backgroundColor = "#ffcc66"; // Aquí puedes ajustar el color según tus necesidades
            fila++;
        }
        ...
        // Analiza si el carácter es '~'
            ...
            // Se agrega la fila
            dgvTabla.Rows.Add("~", "t_negación", "Es un operador lógico de negación.");
            // Se muestra con el color que lo representa como símbolo
            dgvTabla.rows[fila].style.backgroundColor = "#ffcc66"; // Aquí puedes ajustar el color según tus necesidades
            fila++;
        }
        ...
        // Analiza si el carácter es '/'
            ...
            if (linea[i + 1] === '=') {
                // Se agrega la fila
                dgvTabla.Rows.Add("/=", "t_asignación_división", "Es un operador aritmético de asignación para la división.");
            ...
            // Puede ser que el que siga sea '/', entonces se convierte en símbolo de inicio de comentario
                ...
                // Se agrega la fila
                dgvTabla.Rows.Add("//", "t_comen", "Son los símbolos que representan el comienzo de un comentario.");
                ...
                if (linea[i] === '\\' && linea[i + 1] === '\\') {
                    ...
                    dgvTabla.Rows.Add(comenfinal, "t_comenFinal", "Son los símbolos que representan el final de un comentario.");
            ...
            // Si no se encuentra al lado uno de esos símbolos, entonces es un operador de división
                ...
                // Se añade la fila
                dgvTabla.Rows.Add("/", "t_division", "Es un operador aritmético de división.");
                // Se muestra con el color que lo identifica como operador
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
            }
        ...
        // Se analiza si el caracter es '!'
            ...
            if (linea[i + 1] === '=' && linea[i + 2] === '!') {
                ...
                dgvTabla.Rows.Add("!=", "t_diferente", "Es un operador de comparación.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
        ...
        // Se analiza si el caracter es '+'
            ...
            if (linea[i + 1] === '=') {
                // Se añade la fila y se muestra con el color que lo identifica como operador
                dgvTabla.Rows.Add("+=", "t_asignación_suma", "Es un operador aritmético de asignación suma.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
                i++;
            }
            // Si el que sigue es un '+', entonces se trata de un operador de incremento
                ...
                // Se añade la fila y se muestra con el color que lo identifica como operador
                dgvTabla.Rows.Add("++", "t_incremento", "Es un operador aritmético de incremento.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
                i++;
            }
        ...
        // Se analiza si el caracter es '-'
            ...
            if (linea[i + 1] === '=') {
                // Se añade la fila y se muestra con el color que lo identifica como operador
                dgvTabla.Rows.Add("-=", "t_asignación_resta", "Es un operador aritmético de asignación resta.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
                i++;
            }
            // Si el que sigue es un '-', entonces se trata de un operador de decremento
                ...
                // Se añade la fila y se muestra con el color que lo identifica como operador
                dgvTabla.Rows.Add("--", "t_decremento", "Es un operador aritmético de decremento.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
                i++;
            }
            // Si no es ninguno de los anteriores, entonces es solo el operador de resta
                ...
                // Se añade la fila y se muestra con el color que lo identifica como operador
                dgvTabla.Rows.Add("-", "t_resta", "Es un operador aritmético de resta.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
            }
        }
        ...
        // Se analiza si el caracter es '*'
            ...
            if (linea[i + 1] === '=') {
                // Se añade la fila y se muestra con el color que lo identifica como operador
                dgvTabla.Rows.Add("*=", "t_multiplicador", "Es un operador de asignación de multiplicación.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
                i++;
            }
            // Si no es , entonces es solo el operador de multiplicación
                ...
                // Se añade la fila y se muestra con el color que lo identifica como operador
                dgvTabla.Rows.Add("*", "t_produc", "Es un operador aritmético de multiplicación.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
            }
        }
        ...
        // Se analiza si el caracter es '%'
            ...
            if (linea[i + 1] === '=') {
                // Se añade la fila y se muestra con el color que lo identifica como operador
                dgvTabla.Rows.Add("%=", "t_asignación_resto", "Es un operador de asignación resto.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
                i++;
            }
            // Si no es , entonces es solo el operador de resto
                ...
                // Se añade la fila y se muestra con el color que lo identifica como operador
                dgvTabla.Rows.Add("%", "t_modulo", "Es un operador aritmético de resto.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
            }
        }
        ...
        // Se analiza si el caracter es '^'
            ...
            if (linea[i + 1] === '=') {
                // Se añade la fila y se muestra con el color que lo identifica como operador
                dgvTabla.Rows.Add("^=", "t_asignación_potencia", "Es un operador aritmético de asignación potencia.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
                i++;
            }
            // Si el que sigue es ^, entonces se trata de un operador lógico
                ...
                dgvTabla.Rows.Add("^^", "t_exclusivo", "Es un operador logico exclusivo.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
                i++;
            }
            // Si no es , entonces es solo el operador de potencia
                ...
                // Se añade la fila y se muestra con el color que lo identifica como operador
                dgvTabla.Rows.Add("^", "t_potencia", "Es un operador aritmético de potencia.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
            }
        }
        ...
        // Se analiza si el caracter es '&'
            ...
            if (linea[i + 1] === '=') {
                // Se añade la fila y se muestra con el color que lo identifica como operador
                dgvTabla.Rows.Add("&=", "t_asignación_AND", "Es un operador de asignación Y.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
                i++;
            }
            // Si el que sigue es &, entonces se trata de un operador condicional
                ...
                // Se añade la fila y se muestra con el color que lo identifica como operador
                dgvTabla.Rows.Add("&&", "t_condicionalY", "Es un operador condicional Y.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
                i++;
            }
         ...
         // Se analiza si el caracter es '$'
            ...
            if (linea[i + 1] === '$' && linea[i + 2] !== '$') {
                ...
                dgvTabla.Rows.Add("$$", "t_raizCua", "Es un operador aritmético de raíz cuadrada.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
                i++;
            }
            // Si el que sigue es $, y el que sigue de este también es $, se trata de un operador de raíz cúbica
                ...
                // Se añade la fila y se muestra con el color
                dgvTabla.Rows.Add("$$$", "t_raizCub", "Es un operador aritmético de raíz cúbica.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
        ...
        // Se analiza si el caracter es '|'
            ...
            if (linea[i + 1] === '|' && linea[i + 2] === '|') {
                // Se añade la fila y se muestra con el color
                dgvTabla.Rows.Add("|||", "t_condicionalO", "Es un operador condicional O.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
                // Se aumenta i en 2 porque ya se evaluó el siguiente, y el siguiente de este
                i = i + 2;
            ...
            // Si el que sigue es =, entonces se trata de un operador lógico de asignación
                ...
                // Se añade la fila y se muestra con el color
                dgvTabla.Rows.Add("|=", "t_Asignación_OR", "Es un operador logico de asignación.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
                i++;
            }
        ...
        // Se analiza si el caracter es '>'
            ...
            if (linea[i + 1] === '>' && linea[i + 2] === '=') {
                // Se añade la fila y se muestra con el color
                dgvTabla.Rows.Add(">>=", "t_Asignacion_shiftiderecha", "Es un operador de asignación de desplazamiento menor.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
                i = i + 2;
            }
            // Si el siguiente es >, entonces se trata de un operador de desplazamiento
                ...
                // Se añade la fila y se muestra con el color
                dgvTabla.Rows.Add(">>", "t_shiftderecha", "Es un operador de desplazamiento derecho.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
                i++;
            }
            // Si el siguiente es =, entonces se trata de un operador de compación mayor igual que 
                ...
                // Se añade la fila y se muestra con el color
                dgvTabla.Rows.Add(">=", "t_sigmayorigual", "Es un operador de comparación mayor igual que.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
                i++;
            }
            // Si no se encuentra ninguno de los anteriores, entonces es el operador de comparación mayor
                ...
                // Se añade la fila y se muestra con el color
                dgvTabla.Rows.Add(">", "t_sigmayor", "Es un operador de comparación mayor.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
            }
        }
        ...
        // Se analiza si el caracter es '<'
            ...
            if (linea[i + 1] === '<' && linea[i + 2] === '=') {
                // Se añade la fila y se muestra con el color
                dgvTabla.Rows.Add("<<=", "t_Asignacion_shiftizquierda", "Es un operador de asignación de desplazamiento menor.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
                i = i + 2;
            }
            // Si el siguiente es <, entonces se trata de un operador de desplazamiento
                ...
                // Se añade la fila y se muestra con el color
                dgvTabla.Rows.Add("<<", "t_shifizquierda", "Es un operador de desplazamiento izquierdo.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
                i++;
            }
            // Si el siguiente es '=', entonces se trata de un operador de comparación menor igual que
                ...
                // Se añade la fila y se muestra con el color
                dgvTabla.Rows.Add("<=", "t_sigmenorigual", "Es un operador de comparación menor igual que.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
                i++;
            }
            // Si no se encuentra ninguno de los anteriores, entonces es el operador de comparación menor
                ...
                // Se añade la fila y se muestra con el color       
                dgvTabla.Rows.Add("<", "t_sigmenor", "Es un operador de comparación menor.");
                dgvTabla.rows[fila].style.backgroundColor = "#66ffff"; // Aquí puedes ajustar el color según tus necesidades
                fila++;
            }
        }
            ...
            switch (estado) {
              case 1:
                if ((char === 'T' || char === 't') && !charIsLetter(linea[i + 1]) && linea[i + 1] !== '_') {
                  palabra += char;
                  resultados.push({ palabra, tipo: "t_identificador", descripcion: "Secuencia de caracteres alfabéticos.", color: "#CC99FF" });
                  palabra = "";
                } else if (char === 'T' || char === 't') {
                  palabra += char;
                  estado = 2;
                } else if ((charIsLetter(char) && (char !== 'T' || char !== 't')) && !charIsLetter(linea[i + 1])) {
                  palabra += char;
                  resultados.push({ palabra, tipo: "t_identificador", descripcion: "Secuencia de caracteres alfabéticos.", color: "#CC99FF" });
                  palabra = "";
                  ...
                  palabra += char;
                  resultados.push({ palabra, tipo: "t_números", descripcion: "Secuencia de caracteres numéricos.", color: "#FF99FF" });
                  palabra = "";
                  ...
                  palabra += char;
                  resultados.push({ palabra, tipo: "", descripcion: "No es un componente léxico.", color: "#93CDDD" });
                  palabra = "";
                }
                break;
      
              case 2:
                if (char === '_' && (linea[i + 1] === ' ' || !charIsLetter(linea[i + 1]))) {
                  resultados.push({ palabra, tipo: "t_identificador", descripcion: "Secuencia de caracteres alfabéticos.", color: "#CC99FF" });
                  resultados.push({ palabra: "_", tipo: "", descripcion: "No es un componente léxico.", color: "#93CDDD" });
                  palabra = "";
                  estado = 1;
                } else if (char === '_') {
                  k = i;
                  ...
                  palabra += char;
                  resultados.push({ palabra, tipo: "identificador", descripcion: "Secuencia de caracteres alfabéticos.", color: "#CC99FF" });
                  palabra = "";
                  estado = 1;
              ...
              case 3:
                if (charIsLetter(char) && (linea[i + 1] === ' ' || !charIsLetter(linea[i + 1]))) {
                  palabra += char;
                  for (let j = 0; j < 12; j++) {
                    if (palabra === reservadas[j]) {
                      resultados.push({ palabra, tipo: palabra, descripcion: "Es una palabra reservada.", color: "#CCFF66" });
                      palabra = "";
                      j = 12;
                    }
                  }
              ...
              case 5:
                if (charIsDigit(char) && (linea[i + 1] === ' ' || !charIsDigit(linea[i + 1]))) {
                  palabra += char;
                  resultados.push({ palabra, tipo: "t_números", descripcion: "Secuencia de caracteres numéricos.", color: "#FF99FF" });
                  palabra = "";
                  estado = 1;
        ...
        // Si no se ha entrado en ninguna de las sentencias anteriores, quiere decir que dicho caracter no es un componente léxico
            ...
            dgvTabla.Rows[fila].DefaultCellStyle.BackColor = Color.FromArgb(147, 205, 221);
            fila++;
            palabra = "";
            estado = 1;
        }
